...
<p class="lead text-info" style="margin-left: 20px"><c:sr word="User"/>
    <strong><%=request.getSession().getAttribute("username") %>
    </strong></p>
...
<div>
    ...
    <table class="table table-striped"
        ...
        <tr>
            ...
            <td><%=missions.get(i).getMissionname()%>
            </td>
            <td><a href="" onclick="showDetail('<%=missions.get(i).getMissiondiscrip()%>')">detail</a></td>
            <td><%=missions.get(i).getStartTime()%>
            </td>
            <td><%=missions.get(i).getEndTime()%>
            </td>
            <td><strong><%=missions.get(i).getStatus()%>
            </strong></td>
